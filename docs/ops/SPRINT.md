...
**Last Updated:** 2026-04-08 — QA & Standards (odd-hour :00 run BN). **⚠️ NEW P1-NEW-BN-1: RevenueCat product IDs changed in working tree (`kin_monthly_39`, `kin_annual_34900`, $349/yr) but SPRINT.md B2 still references old IDs (`kin_monthly_3999`, `kin_annual_29900`). Risk: Austin creates wrong products in RC dashboard → purchase flow broken on TestFlight. Lead Eng must commit pricing changes + update B2 table BEFORE Austin acts on RC. NEW P2-NEW-BN-1: 3 bare console.error calls in `apps/marketing/src/app/api/waitlist/route.ts` (lines 57/74/80) — not NODE_ENV gated. NEW P2-NEW-BN-2: PaywallModal annual `$25/month` label inconsistent with new $349/year price ($29/month). IE Session 15 prompts (checkin Scenarios 4/5, first-use Scenario 5) verified spec-compliant. Architecture/§5/§7/§8/§12/§16/§23 carry-forward PASS. Full audit: `QA-AUDIT-2026-04-08-RUN-BN.md`.**
